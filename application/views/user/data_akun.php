...
<div class="main-content">
  ...
  <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
      <!-- Brand -->
      <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?= base_url('data_akun') ?>">Data
        Akun</a>
      <!-- Form -->
              ...
              <tbody>
                ...
                foreach ($dataAkun as $row):
                  ...
                  <tr>
                    ...
                    <a href="<?= base_url('data_akun/edit/' . $row->no_reff) ?>" class="btn btn-warning">Edit</a>

                      <?= form_open('fdata_akun/hapus', ['class' => 'form'], ['id' => $row->no_reff]) ?>
